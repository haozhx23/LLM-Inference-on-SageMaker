...
def get_model(properties):
    ...
    # model = AutoModelForCausalLM.from_pretrained(model_name, trust_remote_code=True, device_map="auto").half()#.cuda()
...
def inference(inputs):
    try:
        ...
        with torch.no_grad():
            ...
            inputs = tokenizer(data, return_tensors="pt").to(torch.cuda.current_device())
